...
public class BlockPistonBase extends Block {
    ...
    public BlockPistonBase(boolean isSticky) {
        ...
        setDefaultState(blockState.getBaseState().withProperty(FACING, Direction.NORTH).withProperty(EXTENDED, Boolean.FALSE));
    ...
    public boolean onBlockEventReceived(World worldIn, BlockPos pos, IBlockState state, int eventID, int eventParam) {
        ...
        if (eventID == 0) {
            ...
            worldIn.setBlockState(pos, Blocks.piston_extension.getDefaultState().withProperty(BlockPistonMoving.FACING, enumfacing).withProperty(BlockPistonMoving.TYPE, isSticky ? BlockPistonExtension.PistonType.STICKY : BlockPistonExtension.PistonType.DEFAULT), 3);
    ...
    private boolean doMove(World worldIn, BlockPos pos, Direction direction, boolean extending) {
        ...
        if (!blockpistonstructurehelper.canMove()) {
            ...
            if (extending) {
                BlockPistonExtension.PistonType blockpistonextension$enumpistontype = isSticky ? BlockPistonExtension.PistonType.STICKY : BlockPistonExtension.PistonType.DEFAULT;
                ...
                IBlockState iblockstate2 = Blocks.piston_extension.getDefaultState().withProperty(BlockPistonMoving.FACING, direction).withProperty(BlockPistonMoving.TYPE, isSticky ? BlockPistonExtension.PistonType.STICKY : BlockPistonExtension.PistonType.DEFAULT);
    ...
    public IBlockState getStateForEntityRender(IBlockState state) {
        return getDefaultState().withProperty(FACING, Direction.UP);
    }
