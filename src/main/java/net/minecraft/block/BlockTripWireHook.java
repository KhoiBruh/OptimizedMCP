...
public class BlockTripWireHook extends Block {
    ...
    public BlockTripWireHook() {
        ...
        setDefaultState(blockState.getBaseState().withProperty(FACING, Direction.NORTH).withProperty(POWERED, Boolean.FALSE).withProperty(ATTACHED, Boolean.FALSE).withProperty(SUSPENDED, Boolean.FALSE));
    ...
    public IBlockState onBlockPlaced(World worldIn, BlockPos pos, Direction facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer) {
        IBlockState iblockstate = getDefaultState().withProperty(POWERED, Boolean.FALSE).withProperty(ATTACHED, Boolean.FALSE).withProperty(SUSPENDED, Boolean.FALSE);
    ...
    public void func_176260_a(World worldIn, BlockPos pos, IBlockState hookState, boolean p_176260_4_, boolean p_176260_5_, int p_176260_6_, IBlockState p_176260_7_) {
        Direction enumfacing = hookState.getValue(FACING);
        ...
        flag3 = flag3 & i > 1;
        flag4 = flag4 & flag3;
        IBlockState iblockstate1 = getDefaultState().withProperty(ATTACHED, flag3).withProperty(POWERED, flag4);
        ...
        if (i > 0) {
            ...
            func_180694_a(worldIn, blockpos1, flag3, flag4, flag, flag1);
        }

        func_180694_a(worldIn, pos, flag3, flag4, flag, flag1);
    ...
    private void func_176262_b(World worldIn, BlockPos p_176262_2_, Direction p_176262_3_) {
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(FACING, Direction.getHorizontal(meta & 3)).withProperty(POWERED, (meta & 8) > 0).withProperty(ATTACHED, (meta & 4) > 0);
    }
