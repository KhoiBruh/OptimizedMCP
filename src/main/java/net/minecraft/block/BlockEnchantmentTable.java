                ...
                if (rand.nextInt(16) == 0) {
                    for (int k = 0; k <= 1; ++k) {
                        ...
                        if (worldIn.getBlockState(blockpos).getBlock() == Blocks.bookshelf) {
                            ...
                            worldIn.spawnParticle(ParticleTypes.ENCHANTMENT_TABLE, (double) pos.getX() + 0.5D, (double) pos.getY() + 2.0D, (double) pos.getZ() + 0.5D, (double) ((float) i + rand.nextFloat()) - 0.5D, (float) k - rand.nextFloat() - 1.0F, (double) ((float) j + rand.nextFloat()) - 0.5D);
                        }
                    }
                }
            }
