...
public class BlockAnvil extends BlockFalling {
    ...
    protected BlockAnvil() {
        ...
        setDefaultState(blockState.getBaseState().withProperty(FACING, Direction.NORTH).withProperty(DAMAGE, 0));
        setLightOpacity(0);
    ...
    public IBlockState getStateFromMeta(int meta) {
        return getDefaultState().withProperty(FACING, Direction.getHorizontal(meta & 3)).withProperty(DAMAGE, (meta & 15) >> 2);
    }
