...
public class BlockPumpkin extends BlockDirectional {
    ...
    private void trySpawnGolem(World worldIn, BlockPos pos) {
        ...
        if ((blockpattern$patternhelper = getSnowmanPattern().match(worldIn, pos)) != null) {
            ...
            for (int j = 0; j < 120; ++j) {
                worldIn.spawnParticle(ParticleTypes.SNOW_SHOVEL, (double) blockpos1.getX() + worldIn.rand.nextDouble(), (double) blockpos1.getY() + worldIn.rand.nextDouble() * 2.5D, (double) blockpos1.getZ() + worldIn.rand.nextDouble(), 0.0D, 0.0D, 0.0D);
            }
            ...
            for (int j1 = 0; j1 < 120; ++j1) {
                worldIn.spawnParticle(ParticleTypes.SNOWBALL, (double) blockpos.getX() + worldIn.rand.nextDouble(), (double) blockpos.getY() + worldIn.rand.nextDouble() * 3.9D, (double) blockpos.getZ() + worldIn.rand.nextDouble(), 0.0D, 0.0D, 0.0D);
            }
