...
public class WorldGenBigTree extends WorldGenAbstractTree {
    ...
    void generateLeafNode(BlockPos pos) {
        for (int i = 0; i < leafDistanceLimit; ++i) {
            func_181631_a(pos.up(i), leafSize(i), Blocks.leaves.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.FALSE));
        }
    }
    ...
    void func_175937_a(BlockPos p_175937_1_, BlockPos p_175937_2_, Block p_175937_3_) {
        ...
        for (int j = 0; j <= i; ++j) {
            ...
            BlockLog.Axis blocklog$enumaxis = func_175938_b(p_175937_1_, blockpos1);
