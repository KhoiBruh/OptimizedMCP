...
public class ChatComponentProcessor {
    public static IChatComponent processComponent(ICommandSender commandSender, IChatComponent component, Entity entityIn) throws CommandException {
        ...
        switch (component) {
            ...
            case ChatComponentSelector iChatComponents -> {
                String s1 = iChatComponents.getSelector();
            ...
            case ChatComponentText iChatComponents ->
                    ichatcomponent = new ChatComponentText(iChatComponents.getChatComponentText_TextValue());
            default -> {
