...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    public void renderItem(ItemStack stack, IBakedModel model) {
        if (stack != null) {
            ...
            if (model.isBuiltInRenderer()) {
                ...
                renderModelHasEmissive = false;
                renderModel(model, stack);

                if (renderModelHasEmissive) {
                    ...
                    renderModelEmissive = true;
                    renderModel(model, stack);
                    renderModelEmissive = false;
    ...
    private void registerItems() {
        ...
        itemModelMesher.register(Items.potionitem, stack -> ItemPotion.isSplash(stack.getMetadata())
