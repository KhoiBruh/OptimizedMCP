...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    ...
    private void fixTerrainFrustum(double x, double y, double z) {
        ...
        Matrix4f matrix4f = new Matrix4f(FloatBuffer.wrap(this.debugFixedClippingHelper.modelviewMatrix));
        matrix4f.transpose();
        Matrix4f matrix4f1 = new Matrix4f(FloatBuffer.wrap(this.debugFixedClippingHelper.projectionMatrix));
        matrix4f1.transpose();
