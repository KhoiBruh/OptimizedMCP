        ...
        if (itemstack != null) {
            ...
            if (item instanceof ItemMap) {
                ...
                if (item == Items.compass) {
                    textureatlassprite = mc.getTextureMapBlocks().getAtlasSprite(TextureCompass.locationSprite);
                    ...
                    if (textureatlassprite instanceof TextureCompass texturecompass) {
                        ...
                        texturecompass.updateCompass(itemFrame.worldObj, itemFrame.posX, itemFrame.posZ, MathHelper.wrapAngle((float) (180 + itemFrame.facingDirection.getHorizontalIndex() * 90)), false, true);
