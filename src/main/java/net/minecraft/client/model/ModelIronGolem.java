...
public class ModelIronGolem extends ModelBase {
    ...
    public ModelIronGolem(float p_i46362_1_, float p_i46362_2_) {
        int i = 128;
        int j = 128;
        ironGolemHead = (new ModelRenderer(this)).setTextureSize(i, j);
        ...
        ironGolemBody = (new ModelRenderer(this)).setTextureSize(i, j);
        ...
        ironGolemRightArm = (new ModelRenderer(this)).setTextureSize(i, j);
        ...
        ironGolemLeftArm = (new ModelRenderer(this)).setTextureSize(i, j);
        ...
        ironGolemLeftLeg = (new ModelRenderer(this, 0, 22)).setTextureSize(i, j);
        ...
        ironGolemRightLeg = (new ModelRenderer(this, 0, 22)).setTextureSize(i, j);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ironGolemHead.rotateAngleY = netHeadYaw / (180F / (float) Math.PI);
        ironGolemHead.rotateAngleX = headPitch / (180F / (float) Math.PI);
        ironGolemLeftLeg.rotateAngleX = -1.5F * func_78172_a(limbSwing, 13.0F) * limbSwingAmount;
        ironGolemRightLeg.rotateAngleX = 1.5F * func_78172_a(limbSwing, 13.0F) * limbSwingAmount;
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime) {
        ...
        if (i > 0) {
            ironGolemRightArm.rotateAngleX = -2.0F + 1.5F * func_78172_a((float) i - partialTickTime, 10.0F);
            ironGolemLeftArm.rotateAngleX = -2.0F + 1.5F * func_78172_a((float) i - partialTickTime, 10.0F);
        } else {
            int j = entityirongolem.getHoldRoseTick();

            if (j > 0) {
                ironGolemRightArm.rotateAngleX = -0.8F + 0.025F * func_78172_a((float) j, 70.0F);
