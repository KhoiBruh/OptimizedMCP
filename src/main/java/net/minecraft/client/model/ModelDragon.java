...
public class ModelDragon extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_,
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            spine.rotateAngleY = updateRotations(adouble1[0] - adouble[0]) * (float) Math.PI / 180.0F * f5;
            spine.rotateAngleX = f9 + (float) (adouble1[1] - adouble[1]) * (float) Math.PI / 180.0F * f5 * 5.0F;
            spine.rotateAngleZ = -updateRotations(adouble1[0] - (double) f7) * (float) Math.PI / 180.0F * f5;
            ...
            f3 = (float) ((double) f3
                    - Math.cos(spine.rotateAngleY) * Math.cos(spine.rotateAngleX) * 10.0D);
            f4 = (float) ((double) f4
                    - Math.sin(spine.rotateAngleY) * Math.cos(spine.rotateAngleX) * 10.0D);
            spine.render(scale);
        }
        ...
        head.rotateAngleY = updateRotations(adouble2[0] - adouble[0]) * (float) Math.PI / 180.0F;
        head.rotateAngleZ = -updateRotations(adouble2[0] - (double) f7) * (float) Math.PI / 180.0F;
        head.render(scale);
        GlStateManager.pushMatrix();
        ...
        for (int k = 0; k < 12; ++k) {
            ...
            spine.rotateAngleY = (updateRotations(adouble2[0] - adouble[0]) * f5 + 180.0F) * (float) Math.PI
                    / 180.0F;
            spine.rotateAngleX = f10 + (float) (adouble2[1] - adouble[1]) * (float) Math.PI / 180.0F * f5 * 5.0F;
            spine.rotateAngleZ = updateRotations(adouble2[0] - (double) f7) * (float) Math.PI / 180.0F * f5;
            spine.rotationPointY = f2;
            spine.rotationPointZ = f3;
            spine.rotationPointX = f4;
            f2 = (float) ((double) f2 + Math.sin(spine.rotateAngleX) * 10.0D);
