...
public class ModelHorse extends ModelBase {
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_,
        ...
        if (!flag) {
            ...
            if (f <= 0.0F) {
                ...
                GlStateManager.translate(0.0F, 0.9F * (1.0F - f1) * f + 1.35F * (1.0F - f1) * (1.0F - f),
                        0.15F * (1.0F - f1) * f);
            }
        }
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_,
        ...
        float f = updateHorseRotation(entitylivingbaseIn.prevRenderYawOffset, entitylivingbaseIn.renderYawOffset,
                partialTickTime);
        float f1 = updateHorseRotation(entitylivingbaseIn.prevRotationYawHead, entitylivingbaseIn.rotationYawHead,
                partialTickTime);
        ...
        head.rotateAngleX = f6 * (0.2617994F + f4) + f5 * 2.18166F
                + (1.0F - Math.max(f6, f5)) * head.rotateAngleX;
        head.rotateAngleY = f6 * f3 / (180F / (float) Math.PI)
                + (1.0F - Math.max(f6, f5)) * head.rotateAngleY;
        ...
        body.rotateAngleX = f6 * -45.0F / (180F / (float) Math.PI) + f7 * body.rotateAngleX;
        ...
        field_178711_b.rotationPointZ = 0.02F - f8;
        field_178712_c.rotationPointZ = 0.0F + f8;
        ...
        field_178711_b.rotateAngleX = 0.0F - 0.09424778F * f8;
        field_178712_c.rotateAngleX = 0.0F + 0.15707964F * f8;
        ...
        backLeftShin.rotationPointY = backLeftLeg.rotationPointY
                + MathHelper.sin(((float) Math.PI / 2F) + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
        ...
        frontLeftShin.rotationPointZ = frontLeftLeg.rotationPointZ
                + MathHelper.cos(((float) Math.PI * 3F / 2F) + f17) * 7.0F;
        frontRightShin.rotationPointY = frontRightLeg.rotationPointY
                + MathHelper.sin(((float) Math.PI / 2F) + f18) * 7.0F;
        frontRightShin.rotationPointZ = frontRightLeg.rotationPointZ
                + MathHelper.cos(((float) Math.PI * 3F / 2F) + f18) * 7.0F;
        backLeftLeg.rotateAngleX = f15 + -f10 * 0.5F * p_78086_3_ * f7;
        backLeftShin.rotateAngleX = -0.08726646F * f6
                + (-f10 * 0.5F * p_78086_3_ - Math.max(0.0F, f10 * 0.5F * p_78086_3_)) * f7;
        backLeftHoof.rotateAngleX = backLeftShin.rotateAngleX;
        backRightLeg.rotateAngleX = f15 + f10 * 0.5F * p_78086_3_ * f7;
        backRightShin.rotateAngleX = -0.08726646F * f6
                + (f10 * 0.5F * p_78086_3_ - Math.max(0.0F, -f10 * 0.5F * p_78086_3_)) * f7;
        backRightHoof.rotateAngleX = backRightShin.rotateAngleX;
        frontLeftLeg.rotateAngleX = f17;
        frontLeftShin.rotateAngleX = (frontLeftLeg.rotateAngleX
                + (float) Math.PI * Math.max(0.0F, 0.2F + f16 * 0.2F)) * f6
                + (f11 + Math.max(0.0F, f10 * 0.5F * p_78086_3_)) * f7;
        frontLeftHoof.rotateAngleX = frontLeftShin.rotateAngleX;
        frontRightLeg.rotateAngleX = f18;
        frontRightShin.rotateAngleX = (frontRightLeg.rotateAngleX
                + (float) Math.PI * Math.max(0.0F, 0.2F - f16 * 0.2F)) * f6
                + (-f11 + Math.max(0.0F, -f10 * 0.5F * p_78086_3_)) * f7;
        ...
        tailTip.rotateAngleX = -0.2618F + f12;
    }
}
