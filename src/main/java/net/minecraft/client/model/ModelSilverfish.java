...
public class ModelSilverfish extends ModelBase {
    ...
    public ModelSilverfish() {
        ...
        for (int i = 0; i < silverfishBodyParts.length; ++i) {
            ...
            silverfishBodyParts[i].addBox((float) silverfishBoxLength[i][0] * -0.5F, 0.0F,
                    (float) silverfishBoxLength[i][2] * -0.5F, silverfishBoxLength[i][0], silverfishBoxLength[i][1],
                    silverfishBoxLength[i][2]);
            silverfishBodyParts[i].setRotationPoint(0.0F, (float) (24 - silverfishBoxLength[i][1]), f);
            field_78170_c[i] = f;
        ...
        silverfishWings[0].addBox(-5.0F, 0.0F, (float) silverfishBoxLength[2][2] * -0.5F, 10, 8,
        ...
        silverfishWings[1].addBox(-3.0F, 0.0F, (float) silverfishBoxLength[4][2] * -0.5F, 6, 4,
        ...
        silverfishWings[2].addBox(-3.0F, 0.0F, (float) silverfishBoxLength[4][2] * -0.5F, 6, 5,
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_,
        ...
        for (ModelRenderer silverfishBodyPart : silverfishBodyParts) {
            silverfishBodyPart.render(scale);
        }

        for (ModelRenderer silverfishWing : silverfishWings) {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        for (int i = 0; i < silverfishBodyParts.length; ++i) {
            silverfishBodyParts[i].rotateAngleY = MathHelper
                    .cos(ageInTicks * 0.9F + (float) i * 0.15F * (float) Math.PI) * (float) Math.PI * 0.05F
                    * (float) (1 + Math.abs(i - 2));
            silverfishBodyParts[i].rotationPointX = MathHelper
                    .sin(ageInTicks * 0.9F + (float) i * 0.15F * (float) Math.PI) * (float) Math.PI * 0.2F
                    * (float) Math.abs(i - 2);
        }
