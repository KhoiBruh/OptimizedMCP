...
public class GuiOptionsRowList extends GuiListExtended {
    ...
    public GuiOptionsRowList(Minecraft mcIn, int p_i45015_2_, int p_i45015_3_, int p_i45015_4_, int p_i45015_5_, int p_i45015_6_, GameSettings.Options... p_i45015_7_) {
        ...
        for (int i = 0; i < p_i45015_7_.length; i += 2) {
            ...
            GuiButton guibutton = func_148182_a(mcIn, p_i45015_2_ / 2 - 155, 0, gamesettings$options);
            GuiButton guibutton1 = func_148182_a(mcIn, p_i45015_2_ / 2 - 155 + 160, 0, gamesettings$options1);
    ...
    public GuiOptionsRowList.Row getListEntry(int index) {
        return field_148184_k.get(index);
    }
    ...
    public static class Row implements GuiListExtended.IGuiListEntry {
        ...
        public boolean mousePressed(int slotIndex, int p_148278_2_, int p_148278_3_, int p_148278_4_, int p_148278_5_, int p_148278_6_) {
            if (field_148323_b.mousePressed(field_148325_a, p_148278_2_, p_148278_3_)) {
                ...
                return true;
            } else if (field_148324_c != null && field_148324_c.mousePressed(field_148325_a, p_148278_2_, p_148278_3_)) {
