...
public class GuiBeacon extends GuiContainer {
    ...
    public void initGui() {
        super.initGui();
        buttonList
                .add(beaconConfirmButton = new GuiBeacon.ConfirmButton(-1, guiLeft + 164, guiTop + 107));
        ...
        if (buttonsNotDrawn && i >= 0) {
            ...
            for (int l = 0; l <= 2; ++l) {
                ...
                for (int k1 = 0; k1 < i1; ++k1) {
                    ...
                    GuiBeacon.PowerButton guibeacon$powerbutton = new GuiBeacon.PowerButton(l << 8 | l1,
                            guiLeft + 76 + k1 * 24 - j1 / 2, guiTop + 22 + l * 25, l1, l);
            ...
            for (int l2 = 0; l2 < j2 - 1; ++l2) {
                ...
                GuiBeacon.PowerButton guibeacon$powerbutton2 = new GuiBeacon.PowerButton(i2 << 8 | i3,
                        guiLeft + 167 + l2 * 24 - k2 / 2, guiTop + 47, i3, i2);
            ...
            if (j > 0) {
                GuiBeacon.PowerButton guibeacon$powerbutton1 = new GuiBeacon.PowerButton(i2 << 8 | j,
                        guiLeft + 167 + (j2 - 1) * 24 - k2 / 2, guiTop + 47, j, i2);
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        drawCenteredString(fontRendererObj, I18n.format("tile.beacon.primary"), 62, 10,
                14737632);
        drawCenteredString(fontRendererObj, I18n.format("tile.beacon.secondary"), 169, 10,
                14737632);
    ...
    static class Button extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY) {
            if (visible) {
                ...
                drawTexturedModalRect(xPosition + 2, yPosition + 2, field_146144_p,
                        field_146143_q, 18, 18);
            }
        }
