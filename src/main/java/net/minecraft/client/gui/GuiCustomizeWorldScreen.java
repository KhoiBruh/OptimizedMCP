...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    private void func_175328_i() {
        ...
        field_175333_f = I18n.format("book.pageIndicator", field_175349_r.func_178059_e() + 1, field_175349_r.func_178057_f());
    ...
    private void func_175327_a(float p_175327_1_) {
        ...
        if (gui instanceof GuiTextField guitextfield) {
            ...
            if (f1 != null) {
                ...
                String s = func_175330_b(guitextfield.getId(), f1);
