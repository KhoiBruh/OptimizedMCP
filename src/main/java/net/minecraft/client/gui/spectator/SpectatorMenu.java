...
public class SpectatorMenu {
    ...
    public ISpectatorMenuObject func_178643_a(int p_178643_1_) {
        int i = p_178643_1_ + field_178658_j * 6;
        return field_178658_j > 0 && p_178643_1_ == 0 ? field_178656_c : (p_178643_1_ == 7 ? (i < field_178659_h.func_178669_a().size() ? field_178653_d : field_178654_e) : (p_178643_1_ == 8 ? field_178655_b : (i >= 0 && i < field_178659_h.func_178669_a().size() ? MoreObjects.firstNonNull(field_178659_h.func_178669_a().get(i), field_178657_a) : field_178657_a)));
    }
    ...
    public void func_178644_b(int p_178644_1_) {
        ISpectatorMenuObject ispectatormenuobject = func_178643_a(p_178644_1_);

        if (ispectatormenuobject != field_178657_a) {
            if (field_178660_i == p_178644_1_ && ispectatormenuobject.func_178662_A_()) {
    ...
    static class MoveMenuObject implements ISpectatorMenuObject {
        ...
        public void func_178661_a(SpectatorMenu menu) {
            menu.field_178658_j = field_178666_a;
        }
