...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient {
    ...
    private float func_175265_c() {
        long i = field_175270_h - Minecraft.getSystemTime() + 5000L;
    ...
    public void renderTooltip(ScaledResolution p_175264_1_, float p_175264_2_) {
        if (field_175271_i != null) {
            ...
            if (f <= 0.0F) {
                ...
                SpectatorDetails spectatordetails = field_175271_i.func_178646_f();
                func_175258_a(p_175264_1_, f, i, f2, spectatordetails);
                zLevel = f1;
            }
        }
    }
    ...
    protected void func_175258_a(ScaledResolution p_175258_1_, float p_175258_2_, int p_175258_3_, float p_175258_4_, SpectatorDetails p_175258_5_) {
        ...
        for (int i = 0; i < 9; ++i) {
            func_175266_a(i, p_175258_1_.getScaledWidth() / 2 - 90 + i * 20 + 2, p_175258_4_ + 3.0F, p_175258_2_, p_175258_5_.func_178680_a(i));
        }
    ...
    private void func_175266_a(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_, ISpectatorMenuObject p_175266_5_) {
        ...
        if (p_175266_5_ != SpectatorMenu.field_178657_a) {
            ...
            String s = String.valueOf(GameSettings.getKeyDisplayString(field_175268_g.gameSettings.keyBindsHotbar[p_175266_1_].getKeyCode()));

            if (i > 3 && p_175266_5_.func_178662_A_()) {
                field_175268_g.fontRendererObj.drawStringWithShadow(s, (float) (p_175266_2_ + 19 - 2 - field_175268_g.fontRendererObj.getStringWidth(s)), p_175266_3_ + 6.0F + 3.0F, 16777215 + (i << 24));
            }
        }
    }

    public void renderSelectedItem(ScaledResolution p_175263_1_) {
        int i = (int) (func_175265_c() * 255.0F);

        if (i > 3 && field_175271_i != null) {
            ISpectatorMenuObject ispectatormenuobject = field_175271_i.func_178645_b();
            String s = ispectatormenuobject != SpectatorMenu.field_178657_a ? ispectatormenuobject.getSpectatorName().getFormattedText() : field_175271_i.func_178650_c().func_178670_b().getFormattedText();

            if (s != null) {
                int j = (p_175263_1_.getScaledWidth() - field_175268_g.fontRendererObj.getStringWidth(s)) / 2;
                int k = p_175263_1_.getScaledHeight() - 35;
                GlStateManager.pushMatrix();
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                field_175268_g.fontRendererObj.drawStringWithShadow(s, (float) j, (float) k, 16777215 + (i << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
    ...
    public void func_175259_b(int p_175259_1_) {
        ...
        for (i = field_175271_i.func_178648_e() + p_175259_1_; i >= 0 && i <= 8 && (field_175271_i.func_178643_a(i) == SpectatorMenu.field_178657_a || !field_175271_i.func_178643_a(i).func_178662_A_()); i += p_175259_1_) {
        }

        if (i >= 0 && i <= 8) {
            field_175271_i.func_178644_b(i);
            field_175270_h = Minecraft.getSystemTime();
        }
    }
    ...
    public void func_175261_b() {
        ...
        if (func_175262_a()) {
            int i = field_175271_i.func_178648_e();
