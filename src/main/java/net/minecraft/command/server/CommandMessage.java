    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 2) {
            ...
            if (entityplayer == sender) {
                ...
                chatcomponenttranslation.getChatStyle().setColor(ChatFormat.GRAY).setItalic(Boolean.TRUE);
                chatcomponenttranslation1.getChatStyle().setColor(ChatFormat.GRAY).setItalic(Boolean.TRUE);
