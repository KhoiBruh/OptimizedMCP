...
public class CraftingManager {
    ...
    private CraftingManager() {
        ...
        addShapelessRecipe(new ItemStack(Items.writable_book, 1), Items.book, new ItemStack(Items.dye, 1, DyeColor.BLACK.getDyeDamage()), Items.feather);
        addRecipe(new ItemStack(Blocks.oak_fence, 3), "W#W", "W#W", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.OAK.getMetadata()));
        addRecipe(new ItemStack(Blocks.birch_fence, 3), "W#W", "W#W", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.BIRCH.getMetadata()));
        addRecipe(new ItemStack(Blocks.spruce_fence, 3), "W#W", "W#W", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.SPRUCE.getMetadata()));
        addRecipe(new ItemStack(Blocks.jungle_fence, 3), "W#W", "W#W", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.JUNGLE.getMetadata()));
        addRecipe(new ItemStack(Blocks.acacia_fence, 3), "W#W", "W#W", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.Type.ACACIA.getMetadata() - 4));
        addRecipe(new ItemStack(Blocks.dark_oak_fence, 3), "W#W", "W#W", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.Type.DARK_OAK.getMetadata() - 4));
        addRecipe(new ItemStack(Blocks.cobblestone_wall, 6, BlockWall.Type.NORMAL.getMetadata()), "###", "###", '#', Blocks.cobblestone);
        addRecipe(new ItemStack(Blocks.cobblestone_wall, 6, BlockWall.Type.MOSSY.getMetadata()), "###", "###", '#', Blocks.mossy_cobblestone);
        addRecipe(new ItemStack(Blocks.nether_brick_fence, 6), "###", "###", '#', Blocks.nether_brick);
        addRecipe(new ItemStack(Blocks.oak_fence_gate, 1), "#W#", "#W#", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.OAK.getMetadata()));
        addRecipe(new ItemStack(Blocks.birch_fence_gate, 1), "#W#", "#W#", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.BIRCH.getMetadata()));
        addRecipe(new ItemStack(Blocks.spruce_fence_gate, 1), "#W#", "#W#", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.SPRUCE.getMetadata()));
        addRecipe(new ItemStack(Blocks.jungle_fence_gate, 1), "#W#", "#W#", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.JUNGLE.getMetadata()));
        addRecipe(new ItemStack(Blocks.acacia_fence_gate, 1), "#W#", "#W#", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.Type.ACACIA.getMetadata() - 4));
        addRecipe(new ItemStack(Blocks.dark_oak_fence_gate, 1), "#W#", "#W#", '#', Items.stick, 'W', new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.Type.DARK_OAK.getMetadata() - 4));
        ...
        addRecipe(new ItemStack(Blocks.stone_slab, 6, BlockStoneSlab.Type.COBBLESTONE.getMetadata()), "###", '#', Blocks.cobblestone);
        addRecipe(new ItemStack(Blocks.stone_slab, 6, BlockStoneSlab.Type.STONE.getMetadata()), "###", '#', new ItemStack(Blocks.stone, BlockStone.Type.STONE.getMetadata()));
        addRecipe(new ItemStack(Blocks.stone_slab, 6, BlockStoneSlab.Type.SAND.getMetadata()), "###", '#', Blocks.sandstone);
        addRecipe(new ItemStack(Blocks.stone_slab, 6, BlockStoneSlab.Type.BRICK.getMetadata()), "###", '#', Blocks.brick_block);
        addRecipe(new ItemStack(Blocks.stone_slab, 6, BlockStoneSlab.Type.SMOOTHBRICK.getMetadata()), "###", '#', Blocks.stonebrick);
        addRecipe(new ItemStack(Blocks.stone_slab, 6, BlockStoneSlab.Type.NETHERBRICK.getMetadata()), "###", '#', Blocks.nether_brick);
        addRecipe(new ItemStack(Blocks.stone_slab, 6, BlockStoneSlab.Type.QUARTZ.getMetadata()), "###", '#', Blocks.quartz_block);
        addRecipe(new ItemStack(Blocks.stone_slab2, 6, BlockStoneSlabNew.Type.RED_SANDSTONE.getMetadata()), "###", '#', Blocks.red_sandstone);
        addRecipe(new ItemStack(Blocks.wooden_slab, 6, 0), "###", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.OAK.getMetadata()));
        addRecipe(new ItemStack(Blocks.wooden_slab, 6, BlockPlanks.Type.BIRCH.getMetadata()), "###", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.BIRCH.getMetadata()));
        addRecipe(new ItemStack(Blocks.wooden_slab, 6, BlockPlanks.Type.SPRUCE.getMetadata()), "###", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.SPRUCE.getMetadata()));
        addRecipe(new ItemStack(Blocks.wooden_slab, 6, BlockPlanks.Type.JUNGLE.getMetadata()), "###", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.JUNGLE.getMetadata()));
        addRecipe(new ItemStack(Blocks.wooden_slab, 6, 4 + BlockPlanks.Type.ACACIA.getMetadata() - 4), "###", '#', new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.Type.ACACIA.getMetadata() - 4));
        addRecipe(new ItemStack(Blocks.wooden_slab, 6, 4 + BlockPlanks.Type.DARK_OAK.getMetadata() - 4), "###", '#', new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.Type.DARK_OAK.getMetadata() - 4));
        addRecipe(new ItemStack(Blocks.ladder, 3), "# #", "###", "# #", '#', Items.stick);
        addRecipe(new ItemStack(Items.oak_door, 3), "##", "##", "##", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.OAK.getMetadata()));
        addRecipe(new ItemStack(Items.spruce_door, 3), "##", "##", "##", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.SPRUCE.getMetadata()));
        addRecipe(new ItemStack(Items.birch_door, 3), "##", "##", "##", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.BIRCH.getMetadata()));
        addRecipe(new ItemStack(Items.jungle_door, 3), "##", "##", "##", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.JUNGLE.getMetadata()));
        addRecipe(new ItemStack(Items.acacia_door, 3), "##", "##", "##", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.ACACIA.getMetadata()));
        addRecipe(new ItemStack(Items.dark_oak_door, 3), "##", "##", "##", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.DARK_OAK.getMetadata()));
        ...
        addRecipe(new ItemStack(Blocks.planks, 4, BlockPlanks.Type.OAK.getMetadata()), "#", '#', new ItemStack(Blocks.log, 1, BlockPlanks.Type.OAK.getMetadata()));
        addRecipe(new ItemStack(Blocks.planks, 4, BlockPlanks.Type.SPRUCE.getMetadata()), "#", '#', new ItemStack(Blocks.log, 1, BlockPlanks.Type.SPRUCE.getMetadata()));
        addRecipe(new ItemStack(Blocks.planks, 4, BlockPlanks.Type.BIRCH.getMetadata()), "#", '#', new ItemStack(Blocks.log, 1, BlockPlanks.Type.BIRCH.getMetadata()));
        addRecipe(new ItemStack(Blocks.planks, 4, BlockPlanks.Type.JUNGLE.getMetadata()), "#", '#', new ItemStack(Blocks.log, 1, BlockPlanks.Type.JUNGLE.getMetadata()));
        addRecipe(new ItemStack(Blocks.planks, 4, 4 + BlockPlanks.Type.ACACIA.getMetadata() - 4), "#", '#', new ItemStack(Blocks.log2, 1, BlockPlanks.Type.ACACIA.getMetadata() - 4));
        addRecipe(new ItemStack(Blocks.planks, 4, 4 + BlockPlanks.Type.DARK_OAK.getMetadata() - 4), "#", '#', new ItemStack(Blocks.log2, 1, BlockPlanks.Type.DARK_OAK.getMetadata() - 4));
        ...
        addRecipe(new ItemStack(Blocks.oak_stairs, 4), "#  ", "## ", "###", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.OAK.getMetadata()));
        addRecipe(new ItemStack(Blocks.birch_stairs, 4), "#  ", "## ", "###", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.BIRCH.getMetadata()));
        addRecipe(new ItemStack(Blocks.spruce_stairs, 4), "#  ", "## ", "###", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.SPRUCE.getMetadata()));
        addRecipe(new ItemStack(Blocks.jungle_stairs, 4), "#  ", "## ", "###", '#', new ItemStack(Blocks.planks, 1, BlockPlanks.Type.JUNGLE.getMetadata()));
        addRecipe(new ItemStack(Blocks.acacia_stairs, 4), "#  ", "## ", "###", '#', new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.Type.ACACIA.getMetadata() - 4));
        addRecipe(new ItemStack(Blocks.dark_oak_stairs, 4), "#  ", "## ", "###", '#', new ItemStack(Blocks.planks, 1, 4 + BlockPlanks.Type.DARK_OAK.getMetadata() - 4));
        ...
        addRecipe(new ItemStack(Items.repeater, 1), "#X#", "III", '#', Blocks.redstone_torch, 'X', Items.redstone, 'I', new ItemStack(Blocks.stone, 1, BlockStone.Type.STONE.getMetadata()));
        addRecipe(new ItemStack(Items.comparator, 1), " # ", "#X#", "III", '#', Blocks.redstone_torch, 'X', Items.quartz, 'I', new ItemStack(Blocks.stone, 1, BlockStone.Type.STONE.getMetadata()));
        ...
        addRecipe(new ItemStack(Blocks.stone_button, 1), "#", '#', new ItemStack(Blocks.stone, 1, BlockStone.Type.STONE.getMetadata()));
        addRecipe(new ItemStack(Blocks.wooden_button, 1), "#", '#', Blocks.planks);
        addRecipe(new ItemStack(Blocks.stone_pressure_plate, 1), "##", '#', new ItemStack(Blocks.stone, 1, BlockStone.Type.STONE.getMetadata()));
        ...
        addRecipe(new ItemStack(Items.armor_stand, 1), "///", " / ", "/_/", '/', Items.stick, '_', new ItemStack(Blocks.stone_slab, 1, BlockStoneSlab.Type.STONE.getMetadata()));
