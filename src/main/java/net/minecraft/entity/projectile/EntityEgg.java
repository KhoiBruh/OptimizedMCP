...
public class EntityEgg extends EntityThrowable {
    ...
    protected void onImpact(MovingObjectPosition p_70184_1_) {
        ...
        for (int k = 0; k < 8; ++k) {
            worldObj.spawnParticle(ParticleTypes.ITEM_CRACK, posX, posY, posZ, ((double) rand.nextFloat() - 0.5D) * 0.08D, ((double) rand.nextFloat() - 0.5D) * 0.08D, ((double) rand.nextFloat() - 0.5D) * 0.08D, Item.getIdFromItem(Items.egg));
        }
