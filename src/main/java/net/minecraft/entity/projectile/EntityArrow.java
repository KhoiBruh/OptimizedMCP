...
public class EntityArrow extends Entity implements IProjectile {
    ...
    public EntityArrow(World worldIn, EntityLivingBase shooter, EntityLivingBase target, float velocity, float innacuracy) {
        ...
        if (d3 >= 1.0E-7D) {
            ...
            setThrowableHeading(d0, d1 + (double) f2, d2, velocity, innacuracy);
        }
    }
    ...
    public void setVelocity(double x, double y, double z) {
        ...
        if (prevRotationPitch == 0.0F && prevRotationYaw == 0.0F) {
            ...
            prevRotationYaw = rotationYaw = (float) (MathHelper.atan2(x, z) * 180.0D / Math.PI);
            rotationPitch = (float) (MathHelper.atan2(y, f) * 180.0D / Math.PI);
        ...
        if (inGround) {
            ...
            if (movingobjectposition != null) {
                if (movingobjectposition.entityHit != null) {
                    ...
                    int l = MathHelper.ceil((double) f2 * damage);
