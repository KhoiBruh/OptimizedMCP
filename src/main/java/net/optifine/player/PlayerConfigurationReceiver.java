    ...
    public void fileDownloadFinished(String url, byte[] bytes, Throwable exception) {
        if (bytes != null) {
            try {
                ...
                PlayerConfigurationParser playerconfigurationparser = new PlayerConfigurationParser(player);
                ...
                if (playerconfiguration != null) {
                    ...
                    PlayerConfigurations.setPlayerConfiguration(player, playerconfiguration);
                }
