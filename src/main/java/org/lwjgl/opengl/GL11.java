...
public class GL11 {
    ...
    public static void glColorPointer(int size, boolean unsigned, int stride, ByteBuffer pointer) {
        glColorPointer(size, unsigned ? GL_UNSIGNED_BYTE : GL_BYTE, stride, pointer);
    }
...
// ------- end test duplicate ---------
    ...
    public static void glCallLists(@NativeType("void const *") ByteBuffer lists) {
        nglCallLists(lists.remaining(), GL_UNSIGNED_BYTE, memAddress(lists));
    }
    ...
    public static void glCallLists(@NativeType("void const *") ShortBuffer lists) {
        nglCallLists(lists.remaining(), GL_UNSIGNED_SHORT, memAddress(lists));
    }
    ...
    public static void glCallLists(@NativeType("void const *") IntBuffer lists) {
        nglCallLists(lists.remaining(), GL_UNSIGNED_INT, memAddress(lists));
    }
     ...
     *
     * @param name the property to query. One of:<br><table><tr><td>{@link GL11C#GL_RENDERER RENDERER}</td><td>{@link GL11C#GL_VENDOR VENDOR}</td><td>{@link GL11C#GL_EXTENSIONS EXTENSIONS}</td><td>{@link GL11C#GL_VERSION VERSION}</td><td>{@link org.lwjgl.opengl.GL20#GL_SHADING_LANGUAGE_VERSION SHADING_LANGUAGE_VERSION}</td></tr></table>
    ...
    public static void glIndexPointer(@NativeType("GLsizei") int stride, @NativeType("void const *") ByteBuffer pointer) {
        nglIndexPointer(GL_UNSIGNED_BYTE, stride, memAddress(pointer));
    }
    ...
    public static void glIndexPointer(@NativeType("GLsizei") int stride, @NativeType("void const *") ShortBuffer pointer) {
        nglIndexPointer(GL_SHORT, stride, memAddress(pointer));
    }
    ...
    public static void glIndexPointer(@NativeType("GLsizei") int stride, @NativeType("void const *") IntBuffer pointer) {
        nglIndexPointer(GL_INT, stride, memAddress(pointer));
    }
     ...
     *
     * @param target the texture environment target. One of:<br><table><tr><td>{@link #GL_TEXTURE_ENV TEXTURE_ENV}</td><td>{@link GL14#GL_TEXTURE_FILTER_CONTROL TEXTURE_FILTER_CONTROL}</td><td>{@link org.lwjgl.opengl.GL20#GL_POINT_SPRITE POINT_SPRITE}</td></tr></table>
