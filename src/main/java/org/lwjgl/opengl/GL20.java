...
public class GL20 extends GL15 {
    ...
    public static void glVertexAttribPointer(int index, int size,
        ...
        nglVertexAttribPointer(index, size, unsigned ? GL_UNSIGNED_SHORT : GL_SHORT, normalized, stride, MemoryUtil.memAddress(buffer));
    }

    public static void glVertexAttribPointer(int index, int size,
                                             boolean unsigned, boolean normalized,
                                             int stride, IntBuffer buffer) {
        nglVertexAttribPointer(index, size, unsigned ? GL_UNSIGNED_INT : GL_INT, normalized, stride, MemoryUtil.memAddress(buffer));
    }
    ...
    public static String glGetActiveAttrib(int program, int index, int maxLength,
        ...
        String s = glGetActiveAttrib(program, index, maxLength, sizeType, type);
    ...
    public static String glGetActiveUniform(int program, int index, int maxLength,
        ...
        //TODO if correct
        IntBuffer type = BufferUtils.createIntBuffer(1);
        String s = glGetActiveUniform(program, index, maxLength, sizeType, type);
        sizeType.put(type.get(0));
        return s;
    }
...
*/
    public static void glVertexAttribPointer(int index, int size, boolean normalized, int stride, FloatBuffer buffer) {
        glVertexAttribPointer(index, size, GL_FLOAT, normalized, stride, buffer);
    }
// -- End LWJGL2 part --
